...
const getStack = (t: (content: string, options?: InlineTranslationOptions) => string): StackSection[] => [
  {
    ...
    items: [
      {
        ...
        description:
          t("I couldn't function effectively without my trusty todo list!"),
      },
      {
        name: "Notion",
      ...
      },
      {
        ...
        description:
          t("I switched from Mint to Monarch and have been enjoying it so far."),
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        description:
          t("A flashcard app that uses spaced repetition. I use it to practice vocab."),
      },
      {
        name: "Pimsleur",
        link: "https://pimsleur.com",
        description:
          t("My favorite way to start learning a language. It's based on listening and repetition, so it's great for improving your accent."),
      },
      {
        name: "Glossika",
        link: "https://glossika.com",
        description:
          t("A great way to practice speaking. It's based on listening and repeating sentences and has lots of language pairings (e.g. Czech to Russian)."),
      },
      {
        name: "Mango",
        link: "https://mangolanguages.com",
        description:
          t("Solid alternative to Duolingo. If you have a public library membership, it may be free for you."),
      },
      {
      ...
      },
      {
        ...
        description:
          t("Dictionary with tons of languages and example sentences sourced from the web."),
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        name: "Rust",
        description:
          t("For writing low-level code with a modern build system, great syntax, and no segfaults :)"),
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        description:
          t("Literally so much better than writing CSS by hand in separate files."),
      },
      {
        name: "shadcn/ui",
        link: "https://ui.shadcn.com",
        description:
          t("My go-to for building UI components. Love how they're accessible + customizable!"),
      },
    ],
  },
  {
